...
export const createWindowManager = (TriggerEl: HTMLElement, MenuRef: Ref<HTMLElement | null>, type: 'fixed' | 'flex' = 'fixed', method: 'click' | 'contextmenu' = 'click', onWindowClick: (e: MouseEvent) => void = () => { }): WindowManager => {
